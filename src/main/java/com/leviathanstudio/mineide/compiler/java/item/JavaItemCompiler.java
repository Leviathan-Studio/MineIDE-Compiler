...
public abstract class JavaItemCompiler extends JavaCompilerInformation
{
    ...
    public JavaItemCompiler compile() throws IOException
    {
        ...
        this.setConstructor();
        this.setItemBuilder(TypeSpec.classBuilder(this.getItemClass()).superclass(this.getSuperClass())
                .addModifiers(Modifier.PUBLIC).addMethod(this.getItemConstructor()).build());

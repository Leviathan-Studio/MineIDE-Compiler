    ...
    public static void main(String[] args) throws Exception
    {
        ...
        JavaGameRegistry gameRegistry = new JavaGameRegistry()
        {
            ...
            public void initializeGameRegistry()
            {
                ...
                // this.getGameRegistryList().add(CodeBlock.builder().addStatement("$T.registerItem(" + "$N" + ", " + "\"$L\"" + ")", this.gameRegistryClass, "itemTest", "ItemTest").build());
            }
        }.compile();
        ...
        // this.setCreativeTabStatement(CodeBlock.builder().addStatement("this.$N($T.$L)", "setCreativeTab", creativeTabsClass, this.getCreativeTab()).build());
